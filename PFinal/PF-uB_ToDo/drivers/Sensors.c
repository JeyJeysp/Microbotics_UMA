...
void config_sensors(void)
{
    ...
    //GPIOIntTypeSet(GPIO_PORTC_BASE, PIN_LIN_DD | PIN_LIN_DI | PIN_LIN_TD | PIN_LIN_TI, GPIO_HIGH_LEVEL); // TODO: Antes GPIO_RISING_EDGE
    GPIOPadConfigSet(GPIO_PORTC_BASE, PIN_LIN_DD | PIN_LIN_DI | PIN_LIN_TD | PIN_LIN_TI, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPD);
    ...
    GPIOPinTypeGPIOOutput(GPIO_PORTB_BASE, PIN_LED_G | PIN_LED_B | PIN_LED_Y);
