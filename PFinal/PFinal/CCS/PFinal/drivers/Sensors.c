...
void config_sensors(void)
{
    ...
    //Configuración PC4, PC5, PC6 y PC7 para los sensores de linea
    ...
    GPIOIntTypeSet(GPIO_PORTC_BASE, PIN_LIN_DD | PIN_LIN_DI | PIN_LIN_TD | PIN_LIN_TI, GPIO_FALLING_EDGE);
