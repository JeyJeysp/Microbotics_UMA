                   ...
                   uint32_t ui32MsgValue, void *pvMsgData)
{
    ...
    switch(ui32Event)
    {
        ...
        case USB_EVENT_RX_AVAILABLE:
        {
            ...
            //etsit: Cambiado!! --> manda a la cola de mensaje
            break;
        }
        ...
        case USB_EVENT_DATA_REMAINING:
        {
            ...
            //
            ulCount = (xQueueIsQueueFullFromISR(xRxedChars)) ? 1 : 0; //ETSIS: cambiado para integrar con la cola de mensaje
            return(ulCount);
        }
    ...
    portEND_SWITCHING_ISR( xTaskWoken );	//ETSIT: Da igual que este no sea exactamente el final de la ISR, porque se genera por excepcion de menor prioridad
    return(0);
}

//*****************************************************************************
//
// Iniclializa el interfaz USB-CDC y crea las colas de mensaje internas
//
//*****************************************************************************
...
//Recibe un byte por el interfaz serie emulado USB-CDC
...
//Envia un byte por el interfaz serie emulado USB-CDC
...
//Recibe un conjunto de bytes por el interfaz serie emulado USB-CDC
...
//Envia un conjunto de bytes por el interfaz serie emulado USB-CDC
